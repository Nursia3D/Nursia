...
namespace Nursia.Utility
{
	public static class MathUtils
	{
		...
		public static string FormatFloat(this float f) => f.ToString("0.00", CultureInfo.InvariantCulture);
		...
		public static byte GetChannelValue(this Color c, int channel)
		{
			switch (channel)
			{
				case 0:
			...
			throw new Exception($"Unknown color channel {channel}");
		}

		public static void SetChannelValue(this ref Color c, int channel, byte value)
		{
			switch (channel)
			{
				case 0:
